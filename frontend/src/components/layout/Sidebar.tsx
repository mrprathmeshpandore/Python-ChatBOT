          ...
          <div className="p-3 border-t border-border/50 bg-background/30 backdrop-blur-md space-y-1">
            ...
            <div className="pt-2 mt-2 border-t">
              <div className="flex items-center justify-between px-2 py-1">
                <span className="text-[10px] text-muted-foreground uppercase tracking-wider font-semibold">Engine Status</span>
                <span className="flex items-center gap-1.5 text-xs font-medium">
                  ...
                  <span className="text-xs text-slate-400 font-medium">
                    {healthStatus === 'checking' ? 'Connecting RAG...' : healthStatus === 'running' ? 'Custom RAG Active' : 'RAG Engine Offline'}
                  </span>
                </span>
              </div>
            </div>
